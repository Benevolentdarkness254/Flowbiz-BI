...
class Supplier(db.Model):
    ...
    supplier_type = db.Column(
        db.Enum(SupplierType, values_callable=lambda obj: [e.value for e in obj]),
        nullable=False,
    )
...
class Product(db.Model):
    ...
    category = db.Column(
        db.Enum(ProductCategory, values_callable=lambda obj: [e.value for e in obj]),
        nullable=False,
    )
...
class InventoryMovement(db.Model):
    ...
    movement_type = db.Column(
        db.Enum(StockMovementType, values_callable=lambda obj: [e.value for e in obj]),
        nullable=False,
    )
...
class StockAlert(db.Model):
    ...
    alert_type = db.Column(
        db.Enum(
            "low_stock", "out_of_stock", "reorder_triggered", name="alert_type_enum"
        ),
        nullable=False,
    )
